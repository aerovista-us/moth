// Script to update all pages with complete navigation
const fs = require('fs');
...
// Pages to update (excluding index.html which already has complete navigation)
const pagesToUpdate = [
    'tracking.html',
    'supply.html', 
    'launch.html',
...
// Update all pages
console.log('🚀 Updating navigation on all pages...\n');
